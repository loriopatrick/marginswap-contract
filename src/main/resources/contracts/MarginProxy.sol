...
contract MarginProxy {
  ...
  /*
   * Proxies request to implementation.
   * 
   * referenced from USDC proxy contract
   */
  ...
  /*
   * Called by parent to update implementation
   */
  ...
  function getCode() public view returns (address code_address) {
    assembly {
  ...
  function getParent() public view returns (address parent_address) {
    assembly {
